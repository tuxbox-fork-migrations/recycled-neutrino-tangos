...
#if BOXMODEL_HD51 || BOXMODEL_MULTIBOX || BOXMODEL_MULTIBOXSE || BOXMODEL_HD60 || BOXMODEL_HD61 || BOXMODEL_BRE2ZE4K || BOXMODEL_H7
...
int CNeutrinoApp::loadSetup(const char * fname)
{
	...
	g_settings.webtv_xml_quality = configfile.getInt32("webtv_xml_quality", 1920);
